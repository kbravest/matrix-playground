...
function TransformTracker(context) {
    ...
    this.shear = function(sx, sy) {
        //this.matrix[1] = this.matrix[1] + this.matrix[0] * sx + this.matrix[1] * sy;
        //this.matrix[2] = this.matrix[2] + this.matrix[2] * sx + this.matrix[3] * sy;

        this.matrix[1] = this.matrix[1] + this.matrix[0] * sy;
        this.matrix[2] = this.matrix[2] + this.matrix[3] * sx;
